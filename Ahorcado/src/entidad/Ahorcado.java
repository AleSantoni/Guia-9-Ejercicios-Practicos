...
Juego Ahorcado: Crear una clase Ahorcado (como el juego), la cual deberá contener como atributos,
 un vector con la palabra a buscar, la cantidad de letras encontradas y
...
public class Ahorcado {
    ...
    char[] palabrasalmacenadas=new char[20];

    public Ahorcado() {
    }

    public Ahorcado(char[] palabra, int cantidadMaxima, int letrasEncontrada) {
        this.palabra = palabra;
        this.cantidadMaxima = cantidadMaxima;
        LetrasEncontrada = letrasEncontrada;
    }
    ...
    public char[] getPalabrasalmacenadas() {
        return palabrasalmacenadas;
    }

    public void setPalabrasalmacenadas(char[] palabrasalmacenadas) {
        this.palabrasalmacenadas = palabrasalmacenadas;
    }
}
